...
BEGIN  
	...
	VALUES
	(1, (SELECT Person.Id FROM Person WHERE Person.FirstName = 'Dexter'), (SELECT Company.Name FROM Company WHERE Company.Id = 1), Null, (SELECT Person.FirstName FROM Person WHERE Person.Id = 1) + ' ' + (SELECT Person.LastName FROM Person WHERE Person.Id = 1)),
